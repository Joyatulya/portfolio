...
import { Current_User_Status, Temporal_User_Status } from '../insulinAnalysis';
...
describe('determineUserState', () => {
  ...
  it('should return EUGLYCEMIC_WORSENING when IN_RANGE and WORSENING', () => {
    expect(determineUserState(Current_User_Status.IN_RANGE, Temporal_User_Status.WORSENING)).toBe(UserState.EUGLYCEMIC_WORSENING);
  });
